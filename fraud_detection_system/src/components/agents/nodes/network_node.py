...
prompt = ChatPromptTemplate.from_messages(
    [
        ...
        6. STRICT BUDGET: You are allowed a MAXIMUM of  database queries total per investigation.
        7. EARLY EXIT: If a database query returns "No records found", DO NOT attempt to rewrite the query or fish for data using alternative questions. Stop immediately and summarize your findings based solely on the data you currently have.
...
agent_executor = AgentExecutor(
    ...
    tools=network_tools,
    verbose=True,
    max_iterations=3,  # Safe loop limit for nested investigations [make it 5 in prod]
